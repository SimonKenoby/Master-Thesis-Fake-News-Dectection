...
\begin{figure*}[h]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{chapter/images/data_exploration/liar-liar-tsne_tfidf_500pca.pdf}}
...
\begin{figure*}[h]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{chapter/images/data_exploration/liar-liar-tsne_tfidf_1750pca.pdf}}
  \caption{t-SNE plot for liar-liar dataset.}
...
\begin{figure*}[h]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{chapter/images/data_exploration/fake_corpus_LSA+tfidf.png}}
